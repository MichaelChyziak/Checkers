...
/**
 * Keeps a track of the move list for a checkers pawn piece
 * @author Michael Chyziak (mchyziak@sfu.ca)
 * @version 1
 * @since 16-12-2014 (DD-MM-YYYY)
 */
